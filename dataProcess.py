...
from env import TEST_DAYS, CLOSE, SEQ_LEN, OFFSET, OUT_PARAMS
...
def prepareData(data, file_data_train, file_data_test, file_X_train, file_Y_train, file_X_test, file_Y_test):
    data, scaler = normalization(data)
    print("-----Data is Normalized------")

    train_data, test_data = cutData(data, TEST_DAYS, file_data_train, file_data_test)
